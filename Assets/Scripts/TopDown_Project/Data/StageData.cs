...
namespace TopDown_Project
{
    ...
    {
        public static readonly StageInfo[] Stage = new StageInfo[]
        {
            new StageInfo(0, new WaveData[] {
                new WaveData(new MonsterSpawnData[]
                {
                    new MonsterSpawnData("Gobline", 1),
                }, false, ""),
                ...
                new WaveData(new MonsterSpawnData[]
                {
                    new MonsterSpawnData("Gobline", 2),
                    new MonsterSpawnData("Gobline", 2),
                    new MonsterSpawnData("Gobline", 2),
                }, true, "Orc_Shaman"),
            }),
            new StageInfo(1, new WaveData[] {
                new WaveData(new MonsterSpawnData[]
                {
                    new MonsterSpawnData("Gobline", 5),
                }, false, ""),

                new WaveData(new MonsterSpawnData[]
                {
                    new MonsterSpawnData("Gobline", 10),
                }, false, ""),
